...
**最终定位**：training-free GOP-aware 加速框架，核心方法是 naive I 帧选取，AV-LRM 为低预算场景补充
...
- **论文故事线**：training-free codec-aware 加速框架，利用 GOP 结构作为免费冗余信号
**关键支撑**：
- kr=0.5 零损失（75.93% = Baseline），2.1x 加速
- Two-Regime 理论（覆盖度 vs 精准度的交叉点在 kr≈0.3）
- Sparse@64 零 OOM vs Baseline@64 89% OOM
**决策**：Short 视频为主战场，M/L 转为 scope/limitation 分析

---

## Phase 4: 当前状态与待办（2.24 - 现在）
